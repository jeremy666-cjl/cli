...
func mustRenderMix(t *testing.T, xml string, metas map[string]*eqafetch.ImageMeta, mode eqafetch.ImageURLMode, maxRows int) string {
	t.Helper()
...
func TestRenderMix_List(t *testing.T) {
	...
	got := mustRenderMix(t, ul, nil, eqafetch.ModeOne, 0)
	...
	gotO := mustRenderMix(t, ol, nil, eqafetch.ModeOne, 0)
...
func TestRenderMix_SheetTruncation(t *testing.T) {
	...
	got := mustRenderMix(t, b.String(), nil, eqafetch.ModeOne, 2)
...
func TestRenderMix_WhiteboardPlaceholder(t *testing.T) {
	t.Parallel()
	got := mustRenderMix(t, `<whiteboard id="wb" token="board_tok"></whiteboard>`, nil, eqafetch.ModeOne, 0)
...
func TestRenderMix_UnescapesEntities(t *testing.T) {
	t.Parallel()
	got := mustRenderMix(t, `<p>a &amp; b &lt; c &gt; d &quot; e &apos; f</p>`, nil, eqafetch.ModeOne, 0)
...
func TestRenderMix_CellImageMarker(t *testing.T) {
	...
	xml := `<sheet id="s"><table>` +
		...
		`</table></sheet>`
	got := mustRenderMix(t, xml, metas, eqafetch.ModeOne, 0)
...
func TestRenderMix_EmptyInput(t *testing.T) {
	t.Parallel()
	got := mustRenderMix(t, ``, nil, eqafetch.ModeOne, 0)
